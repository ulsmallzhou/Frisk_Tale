...
void pr_home(position pos, int refresh);

void pr_home_start(position pos, int refresh);
void pr_home_glory(position pos, int refresh);
void pr_home_option(position pos, int refresh);

void pr_home_start_play(position pos, int refresh);
void pr_home_start_play(position pos, int refresh);
void pr_home_start_saveload(position pos, int refresh);
